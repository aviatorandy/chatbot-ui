...
AS $$
DECLARE
  project_url TEXT := 'https://ruuypexalcclhbhmbhex.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ1dXlwZXhhbGNjbGhiaG1iaGV4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MTIyNTAyMCwiZXhwIjoyMDU2ODAxMDIwfQ.RB5aCxxj3dKNHCcospqibAaqUnP62JIv9OW-fkRtDeE'; -- full access needed for http request to storage
